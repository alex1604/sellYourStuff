module.exports = {
  generateData: (times) => {
    ...
    const up = [
      "https://ca.slack-edge.com/T6RE0MQD7-U6V4E8MBM-3d64322266dc-48",
      "https://ca.slack-edge.com/T6RE0MQD7-U6VU3FFFY-423698c00f22-48",
      "https://ca.slack-edge.com/T6RE0MQD7-U6WA7CBML-f29606c9a625-48",
      "https://ca.slack-edge.com/T6RE0MQD7-U6XBD3TKR-776889f72b0d-72",
      "https://ca.slack-edge.com/T6RE0MQD7-U74FAAYB0-42e1dd31e07b-72",
    ];
    const info = [
      ...
      "Buy this! It's practically illegal considering how cheap it was. In fact, it might be, watch out for the cops",
    ];
    const pi = [];
